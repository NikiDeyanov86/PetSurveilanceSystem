...
app.config['MQTT_LAST_WILL_TOPIC'] = 'pss/#'
app.config['MQTT_LAST_WILL_MESSAGE'] = 'server_down'

# app.config['TEMPLATES_AUTO_RELOAD'] = True
# socketio = SocketIO(app)

flask_client = Mqtt(app)
...
# flask_client.on_connect = handle_connect
# flask_client.on_message = handle_message
# flask_client.on_publish = handle_publish
